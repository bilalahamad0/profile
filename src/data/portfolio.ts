...
export const projectsData = [
  {
    ...
    description: "A fully automated pipeline that unifies WARN Act layoff notices from 46 states and DC into one searchable national dataset with a free JSON API and per-state email alerts — ETag caching, MD5 verification, and GitHub Actions CI/CD, twice daily, zero human intervention.",
  ...
  },
  {
    ...
    description: "An IoT orchestration layer for automated prayer-time notifications. Integrates Raspberry Pi with Sony Android TV via ADB, managing media state and low-level commands. Built from scratch with AI pair programming, compressing a 3-week engineering cycle into 4 days.",
  ...
  },
  {
    ...
    description: "Originally a manual Python script parsing T-Mobile family plan PDFs to split costs, now a fully automated, event-driven E2E system: a Mac Folder Action watches ~/Downloads, processes each new bill the moment it lands, calculates splits, and emails Zelle-ready summaries.",
  ...
  },
  {
    ...
    description: "A Manifest V3 browser extension — one codebase live on the Chrome Web Store, Firefox Add-ons and Edge Add-ons — with a live countdown to the next prayer that auto-pauses every playing video/audio across all open tabs at Adhan time. Built in one day with Claude Code.",
    category: "AI-Powered" as ProjectCategory,
