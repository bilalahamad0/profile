...
export const experienceData = [
  {
    ...
    desc: "Leading architecture and validation for a Unified Sensor Integration IDE from concept to MVP, automating OEM dependency integration and standardizing sensor-level code extensions.",
    highlights: [
      "Engineered a pre-validated compatibility layer for industry-standard chips (ARM, ESP32) and sensors (LiDAR/Radar), cutting manual bring-up cycles by an estimated 70%.",
      "Built a containerized Docker/QEMU test bench that runs A/B validation and system-level performance engineering before any physical hardware exists.",
  ...
  },
  {
    ...
    desc: "Led end-to-end system test strategy for the IoT Dash Cam product series within an AI/ML video-based safety ecosystem.",
    highlights: [
      "Built automated test pipelines for video quality, AI/ML algorithm accuracy, and workload performance across the Dash Cam product series.",
      "Cut regression cycles by 50% and accelerated release cadence by automating network reliability and connectivity testing.",
    ],
  ...
  },
  {
    ...
    desc: "Owned test delivery for vehicle computational systems, taking safety-critical firmware versions through release.",
    highlights: [
  ...
  },
  {
    ...
    highlights: [
      ...
      "Ran integration, performance, and stability testing across all three vehicle programs (R1T, R1S, Fleet) through continuous release cycles.",
      "Met critical KPI targets spanning the Out-of-Box Experience through the full in-car user-flow life cycle.",
    ],
  ...
  },
  {
    ...
    highlights: [
      ...
      "Set up test labs and CI/CD pipelines running continuously across 50+ devices, achieving 30% fewer post-launch issues.",
  ...
  },
  {
    ...
    desc: "Led system testing for Google's VR Controller program, shipping 1st & 2nd Gen controllers and the Daydream View headset.",
    highlights: [
      ...
      "Identified VR test features and built coverage across all three shipping products, closing gaps in product readiness.",
  ...
  },
  {
    ...
    highlights: [
      "Expanded test scope by 40% and cut execution time by 50% through modular architecture and programmable actions.",
    ],
  ...
  },
  {
    ...
    highlights: [
      "Re-architected the WLAN IOT test automation framework to add Android OS support, saving $1.3M.",
  ...
  },
  {
    ...
    desc: "Led functional and integration testing for web portal applications, covering performance and end-user workflows.",
    highlights: [
...
export const projectsData = [
  ...
  },
  {
    ...
    description: "An event-driven billing pipeline that splits a T-Mobile family plan the moment the bill lands: a Mac Folder Action watches ~/Downloads, parses each new PDF, calculates every line's share, and emails Zelle-ready summaries. Started as a manual Python script, now fully automated E2E.",
  ...
  },
  {
    ...
    description: "A production Next.js portfolio built end-to-end with AI pair programming (Antigravity + Gemini), fully responsive and dark-mode. Features glassmorphism design, live GitHub data, Vercel Analytics, Google Analytics with custom events, and an interactive Certifications gallery.",
