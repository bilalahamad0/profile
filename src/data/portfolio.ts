...
export const projectsData = [
  ...
  },
  {
    ...
    aiContribution: 95,
    impact: "Auto-pauses media across every Chrome tab at Adhan time · cross-tab prayer-focus mode · 31 tests, 3 suites",
    gradient: "from-emerald-600/20 via-emerald-500/10 to-transparent",
    accent: "emerald",
    relatedPosts: [],
