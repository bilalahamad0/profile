      ...
      <section id="experience" className={`w-full max-w-7xl mx-auto px-4 sm:px-6 ${showOnlyResume ? 'py-10' : 'pt-24 pb-10'}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            <div className="lg:col-span-4 grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              >
                      ...
                      >
                        <div className="flex flex-col items-center">
                          ...
                          ${exp.faang
                              ...
                              : (exp as any).isStealth
                                ...
                                : 'bg-ink/5 border-line/10 group-hover:bg-blue-500/20 group-hover:border-blue-500/50'
                            }`}
                          >
                            <img
                              src={exp.file}
                        ...
                        <div className="pb-4 pt-1">
                          <div className="flex flex-col sm:flex-row sm:items-baseline gap-1 sm:gap-3">
                            <h3 className="text-lg font-semibold text-ink leading-tight whitespace-pre-line">{exp.role}</h3>
                            <span className="font-medium tracking-tight whitespace-pre-line text-emerald-700 dark:text-emerald-400">
                              {exp.company}
                            </span>
                          </div>
                          <p className="text-xs sm:text-xs text-ink-muted mb-2 mt-1 flex items-center gap-2 whitespace-nowrap">
                          ...
                          <p className="text-sm text-ink-muted leading-relaxed max-w-md mb-3">{exp.desc}</p>
                          {/* Achievement bullets */}
                            ...
                            <ul className="space-y-1.5 max-w-md">
                              {(exp as any).highlights.map((h: string, hi: number) => (
                                <li key={hi} className="flex items-start gap-2 text-xs text-ink-muted leading-relaxed">
                                  <Check className="w-3 h-3 text-emerald-600 dark:text-emerald-500 shrink-0 mt-0.5" />
                                  <span>{h}</span>
                                </li>
                              ))}
                            </ul>
                ...
                {experienceData.length > smartLimit && (
                  <button
                    ...
                    className="mt-6 flex items-center justify-center w-full py-3 rounded-xl border border-line/10 bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:bg-white/10 text-zinc-700 dark:text-zinc-300 transition-colors gap-2 text-sm font-medium z-20 relative"
                  >
                    {isExpanded ? (
              ...
              <div className="flex flex-col h-full">
                <div ref={rightColumnRef} className="flex flex-col gap-6 h-full">
                  ...
                  >
                    <h2 className="t-h3 text-ink mb-5 flex items-center gap-2">
                  ...
                  >
                    <h2 className="t-h3 text-ink mb-5 flex items-center gap-2">
                      <Terminal className="w-6 h-6 text-purple-700 dark:text-purple-400" />
                      Technical Arsenal
                    </h2>
                    <div className="flex flex-wrap gap-2.5">
                      {skills.map((skill) => (
                        <span key={skill.name} className="px-3.5 py-1.5 rounded-lg bg-black/5 dark:bg-white/5 border border-line/10 text-sm font-medium text-zinc-800 dark:text-zinc-200 hover:bg-black/10 dark:bg-white/10 hover:border-line/20 transition-all flex items-center gap-2 cursor-default group">
                  ...
                  >
                    <h2 className="t-h3 text-ink mb-5 flex items-center gap-2">
                      <GraduationCap className="w-6 h-6 text-indigo-700 dark:text-indigo-400" />
                      Education
                    </h2>
                  ...
                  >
                    <Settings className="absolute -right-8 -bottom-8 w-48 h-48 text-ink-muted/5 pointer-events-none" />
                    <div className="flex items-center justify-between mb-5 relative z-10">
                      <h2 className="t-h3 text-ink flex items-center gap-2">
                        <Settings className="w-6 h-6 text-ink-muted" />
                        Certifications
                      </h2>
                      <Link href="/certifications" className="flex items-center gap-1.5 t-label font-bold text-blue-700 hover:text-blue-800 dark:text-blue-500 dark:hover:text-blue-400 transition-colors uppercase tracking-widest">
                    ...
                    {/* AI / Machine Learning */}
                    <div className="mb-4">
                      <span className="t-label font-black uppercase tracking-[0.2em] text-purple-700 dark:text-purple-400 mb-2 flex items-center gap-1.5">
                        ...
                        {["Software Testing Foundations: Integrating AI into Quality Process (2026)", "AI Coding Agents with GitHub Copilot and Cursor (2025)", "AI for App building (2026)"].map((cert, idx) => (
                          <li key={idx} className="flex items-start gap-3">
                            <div className="flex-shrink-0 mt-0.5 w-5 h-5 rounded-md bg-purple-500/10 flex items-center justify-center border border-purple-500/20">
                              <Box className="w-3 h-3 text-purple-700 dark:text-purple-400" />
                            </div>
                    ...
                    {/* Testing & Standards */}
                    <div className="mb-4">
                      <span className="t-label font-black uppercase tracking-[0.2em] text-amber-700 dark:text-amber-400 mb-2 flex items-center gap-1.5">
                        ...
                        {["ISTQB Certified Tester Foundation Level (CTFL)"].map((cert, idx) => (
                          <li key={idx} className="flex items-start gap-3">
                            <div className="flex-shrink-0 mt-0.5 w-5 h-5 rounded-md bg-amber-500/10 flex items-center justify-center border border-amber-500/20">
                              <Box className="w-3 h-3 text-amber-700 dark:text-amber-400" />
                            </div>
                            <span className="text-sm text-zinc-700 dark:text-zinc-300 leading-snug">{cert}</span>
                          </li>
                        ))}
                    ...
                    <div className="mb-4">
                      <span className="t-label font-black uppercase tracking-[0.2em] text-blue-700 dark:text-blue-400 mb-2 flex items-center gap-1.5">
                        ...
                        {["How to Master Your Executive Presence (2023)", "Project Management Foundations (2023)", "Scrum: Advanced (2021)"].map((cert, idx) => (
                          <li key={idx} className="flex items-start gap-3">
                            <div className="flex-shrink-0 mt-0.5 w-5 h-5 rounded-md bg-blue-500/10 flex items-center justify-center border border-blue-500/20">
                              <Box className="w-3 h-3 text-blue-700 dark:text-blue-400" />
                            </div>
                            <span className="text-sm text-zinc-700 dark:text-zinc-300 leading-snug">{cert}</span>
                          </li>
                        ))}
                  ...
                  >
                    ...
                    <p className="text-sm text-ink-muted mb-6 relative z-10">L&amp;T Infotech (2010–2011)</p>

                    <button
                      className="relative w-full mb-6 rounded-2xl overflow-hidden border border-line/10 cursor-zoom-in group text-left block"
                    ...
                    <div className="space-y-3 relative z-10">
                      <div className="p-4 rounded-2xl bg-yellow-500/5 border border-yellow-500/20">
                        <div className="flex items-start gap-3">
                          <span className="text-yellow-700 dark:text-yellow-400 text-lg shrink-0">⭐</span>
                          <div>
                            ...
                            <p className="text-xs text-ink-muted mt-1 leading-relaxed">Architected test automation infrastructure for Motorola ODC, validating multiple mobile platforms. Reduced man-hours by 25% through innovative automation of cumbersome stability testing procedures.</p>
                          </div>
                        </div>
                      </div>
                      <div className="p-4 rounded-2xl bg-blue-500/5 border border-blue-500/20">
                        <div className="flex items-start gap-3">
                          <span className="text-blue-700 dark:text-blue-400 text-lg shrink-0">⭐</span>
                          <div>
                            ...
                            <p className="text-xs text-ink-muted mt-1 leading-relaxed">Led the Development project for Motorola Mobility System Testing, achieving remarkable productivity growth.</p>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    ...
                    <div className="absolute top-1/2 left-0 w-64 h-64 bg-blue-500/10 opacity-40 dark:opacity-100 rounded-full blur-[80px] pointer-events-none -translate-y-1/2" />
                    <div className="flex flex-col z-10 w-full relative">
                      ...
                      <a href="https://developers.google.com/profile/u/bahamad" target="_blank" rel="noreferrer" className="text-ink-muted hover:text-blue-700 dark:hover:text-blue-600 font-medium mb-6 font-mono text-sm underline underline-offset-4 decoration-zinc-700 inline-block w-fit transition-colors">
                        g.dev/bahamad
                      </a>
                      ...
                      <h3 className="t-label font-bold text-ink-muted uppercase tracking-widest mb-4">I/O Attendance & Badges</h3>
                      <div className="flex flex-wrap gap-2.5 mb-8">
                        <span className="px-3 py-1.5 rounded-full bg-ink/5 border border-line/10 t-label font-medium text-zinc-700 dark:text-zinc-300">I/O 2023-25 Attendee</span>
                        <span className="px-3 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 t-label font-semibold text-emerald-700 dark:text-emerald-400">{badgeCount} Badges</span>
                      </div>
                      <div className="w-full relative group/reel">
                        ...
                        >
                          {[
                            ...
                            <a key={i} href={`https://developers.google.com/profile/badges/events/${item.href}`} target="_blank" rel="noreferrer" className="relative w-40 h-52 min-w-[10rem] flex-shrink-0 rounded-xl border-2 border-line/10 dark:border-zinc-800 bg-ink/5 dark:bg-zinc-900 snap-center group shadow-lg overflow-hidden">
                          ...
                          <a href="https://developers.google.com/profile/badges/events/io/2022/attendee" target="_blank" rel="noreferrer" className="relative w-40 h-52 min-w-[10rem] flex-shrink-0 rounded-xl border-2 border-line/10 dark:border-zinc-800 bg-ink/5 dark:bg-zinc-900 snap-center group shadow-lg overflow-hidden">
          ...
          {!showOnlyResume && (
            ...
            >
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-line/10 pb-8">
                <div>
                  <h2 className="t-h2 text-ink flex items-center gap-3">
                    <Layout className="w-8 h-8 text-blue-700 dark:text-blue-500" />
                    Featured Public Projects
                  </h2>
                  <p className="text-ink-muted mt-2 font-medium">Spotlight on high-impact open source tools and IoT orchestration.</p>
                </div>
                <div className="flex items-center gap-4">
                  <div className="px-4 py-2 rounded-full bg-blue-500/10 border border-blue-500/20 text-xs font-bold text-blue-700 dark:text-blue-500 uppercase tracking-widest animate-pulse">
                    Live & Public
                  </div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 gap-8">
                ...
                <div className="glass-card rounded-[2.5rem] p-8 flex flex-col gap-8 relative overflow-hidden group border-line/10 hover:border-blue-500/20 transition-all duration-700">
                  ...
                  <div className="flex flex-col gap-6 relative z-10">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-2xl bg-blue-500/10 flex items-center justify-center border border-blue-500/20">
                          <Monitor className="w-6 h-6 text-blue-700 dark:text-blue-500" />
                        </div>
                        <div>
                          <h3 className="t-h3 text-ink">California Live Layoff Monitoring Dashboard</h3>
                          <div className="flex gap-3 mt-1">
                            {repos.find(r => r.name === 'warn') && (
                              <div className="flex gap-3 text-xs text-ink-muted font-bold uppercase tracking-widest">
                                <span className="flex items-center gap-1.5"><Star className="w-3.5 h-3.5 text-amber-700 fill-amber-700 dark:text-yellow-500 dark:fill-yellow-500" /> {repos.find(r => r.name === 'warn')?.stargazers_count}</span>
                      ...
                      <a href="https://github.com/bilalahamad0/warn" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-ink/5 flex items-center justify-center hover:bg-blue-500 hover:text-white transition-all">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {['Python', 'GitHub Actions', 'ETag Cache', 'Data Visualization', 'MD5 Verification'].map(tag => (
                        <span key={tag} className="px-3 py-1 rounded-full bg-ink/5 border border-line/10 t-label font-bold text-ink-muted uppercase tracking-widest">{tag}</span>
                      ))}
                    </div>

                    <div className="pt-2 flex items-center gap-2 text-blue-700 dark:text-blue-500 font-black t-label uppercase tracking-[0.2em]">
                      <Monitor className="w-4 h-4" /> Production Ready Output
                    </div>
                  </div>

                  <div 
                    className="relative w-full h-[500px] overflow-hidden rounded-3xl border border-line/10 bg-black/20 group/img shadow-2xl cursor-pointer"
                ...
                <div className="glass-card rounded-[2.5rem] p-8 flex flex-col gap-8 relative overflow-hidden group border-line/10 hover:border-emerald-500/20 transition-all duration-700">
                  <div className="absolute top-0 right-0 p-12 opacity-[0.03] pointer-events-none group-hover:scale-110 transition-transform duration-1000">
                  ...
                  <div className="flex flex-col gap-6 relative z-10">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-2xl bg-emerald-500/10 flex items-center justify-center border border-emerald-500/20">
                          <Smartphone className="w-6 h-6 text-emerald-700 dark:text-emerald-500" />
                        </div>
                        <div>
                          <h3 className="t-h3 text-ink">Smart-Home IoT Media Caster</h3>
                          <div className="flex gap-3 mt-1">
                            {repos.find(r => r.name === 'adhan-api') && (
                              <div className="flex gap-3 text-xs text-ink-muted font-bold uppercase tracking-widest">
                                <span className="flex items-center gap-1.5"><Star className="w-3.5 h-3.5 text-amber-700 fill-amber-700 dark:text-yellow-500 dark:fill-yellow-500" /> {repos.find(r => r.name === 'adhan-api')?.stargazers_count}</span>
                      ...
                      <a href="https://github.com/bilalahamad0/adhan-api" target="_blank" rel="noreferrer" className="w-10 h-10 rounded-full bg-ink/5 flex items-center justify-center hover:bg-emerald-500 hover:text-white transition-all">
                        <Github className="w-5 h-5" />
                      </a>
                    </div>
                    ...
                    <div className="pt-2 flex items-center gap-2 text-emerald-700 dark:text-emerald-500 font-black t-label uppercase tracking-[0.2em]">
                ...
                {repos.filter(r => !['warn', 'adhan-api'].includes(r.name)).length > 0 ?
                  repos.filter(r => !['warn', 'adhan-api'].includes(r.name)).map((repo) => (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="block p-4 rounded-xl border border-line/5 bg-black/5 dark:bg-white/5 hover:bg-black/10 dark:bg-white/10 transition-colors group"
                    >
                      <div className="flex items-start sm:items-center justify-between mb-2 gap-4 flex-col sm:flex-row">
                        <div className="flex items-center gap-3 w-full sm:w-auto overflow-hidden">
                          <h4 className="text-sm font-semibold text-blue-700 dark:text-blue-400 group-hover:text-blue-900 dark:text-blue-300 dark:group-hover:text-blue-700 transition-colors truncate">{repo.name}</h4>
                          {repo.language && (
                        ...
                        <div className="flex gap-3 text-xs text-ink-muted font-medium shrink-0">
                      ...
                      <p className="text-xs text-ink-muted leading-relaxed">{repo.description || "No description provided."}</p>
                    </a>
                  )) : (
                    <div className="flex items-center justify-center p-8 text-ink-muted text-sm border border-line/5 rounded-xl border-dashed">
