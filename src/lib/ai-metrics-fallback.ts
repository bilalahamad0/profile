  ...
  warn: {
    ...
    agents: [
      ...
      },
      {
        ...
        models: ["Claude Opus 5", "Claude Fable 5", "Claude Fable 5.1", "Claude Opus 4.8"],
        tokens: 291411151,
        role: "50-state expansion, national dataset & US dashboard",
      },
    ],
    totalTokens: 291611151,
    totalCommits: 457,
    linesOfCode: 43890,
    devCycleDays: 31,
    ...
    agents: [
      {
        name: "Antigravity",
        provider: "Google DeepMind",
        period: "Feb – Apr 2026, May 2026",
        models: ["Gemini 2.5 Flash", "Gemini 2.5 Pro", "Gemini 3 Flash"],
        tokens: 1306992,
        role: "v1–v2 architecture & edge automation",
      },
      {
        name: "Cursor",
        provider: "Anthropic",
    ...
    agents: [
      {
        ...
        models: ["Gemini 2.5 Flash", "Gemini 2.5 Pro", "Gemini 3 Flash", "Gemini 3.8 Flash"],
        tokens: 33393318,
        role: "Foundation, MVP architecture & interactive systems engineering",
      },
      {
        name: "Cursor",
        provider: "Anthropic",
