...
The site is composed of multiple pages (Home, Skills, Experience, Projects, Education, Testimonials and Contact) with a sticky navigation bar. GitHub and LinkedIn badges appear in the header, and a placeholder PDF is available for a resume download. SEO metadata and structured schema data are included for discoverability.
