...
date: "2025-08-20"
description: "How I built a fully automated pipeline that turns raw California WARN Act filings into live layoff intelligence — twice daily, zero human intervention."
...
> **Update, August 2026:** this pipeline has since gone national — 46 states plus DC in one dataset. The California dashboard described below now lives at [bilalahamad0.github.io/warn/ca/](https://bilalahamad0.github.io/warn/ca/) as a deep-dive inside the US tracker. How that scaling worked is a story of its own: [From One State to 47](/blog/warn-tracker-goes-national).
...
I built this with **Cursor (Gemini 2.5 Pro)** as my pair programming partner. The AI contributed:
...
*View the live California dashboard at [bilalahamad0.github.io/warn/ca/](https://bilalahamad0.github.io/warn/ca/), the [national tracker](https://bilalahamad0.github.io/warn/) it now sits inside, or explore the [source code](https://github.com/bilalahamad0/warn).*
