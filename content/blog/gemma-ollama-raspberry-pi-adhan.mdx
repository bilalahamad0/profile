...
date: "2026-05-22"
description: "How I embedded a local Gemma 3 (1B) model via Ollama into a production Raspberry Pi 4 system — a natural-language assistant that self-diagnoses failures."
