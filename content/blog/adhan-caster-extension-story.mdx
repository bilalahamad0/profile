...
> **Related project:** [Adhan Caster — Cross-Browser Extension](https://bilalahamad.com/projects#adhan-ce) — now live on the **[Chrome Web Store](https://chromewebstore.google.com/detail/adhan-caster-muslim-praye/jfjknglldcdminelckmmfdbnlikiogia)** , **[Firefox Add-ons](https://addons.mozilla.org/en-US/firefox/addon/adhan-caster-prayer-times/)** and **[Edge Add-ons](https://microsoftedge.microsoft.com/addons/detail/adhan-caster-muslim-pray/kapmpaofgphfbkpkmhhiooafplhckblg)** · source on [GitHub](https://github.com/bilalahamad0/adhan-ce). It's the browser-side sibling of my Raspberry Pi [Smart-Home IoT Media Caster](https://bilalahamad.com/projects#adhan) and reuses the same [adhan-api](https://github.com/bilalahamad0/adhan-api) schedule source.
