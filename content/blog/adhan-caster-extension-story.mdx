---
title: "Adhan Caster for Chrome: Pausing Every Tab at Prayer Time"
date: "2026-05-24"
description: "How I built a Manifest V3 Chrome extension in a single day with Claude Code — a live prayer-time countdown that auto-pauses media in every tab at Adhan."
tags: ["Chrome Extension", "Manifest V3", "JavaScript", "Service Worker", "AI-Assisted", "Claude Code"]
category: "Project Story"
featured: false
---

> **Related project:** [Adhan Caster — Cross-Browser Extension](https://bilalahamad.com/projects#adhan-ce) — now live on the **[Chrome Web Store](https://chromewebstore.google.com/detail/adhan-focus-muslim-prayer/jfjknglldcdminelckmmfdbnlikiogia)** , **[Firefox Add-ons](https://addons.mozilla.org/en-US/firefox/addon/adhan-caster-prayer-times/)** , **[Edge Add-ons](https://microsoftedge.microsoft.com/addons/detail/adhan-caster-muslim-pray/kapmpaofgphfbkpkmhhiooafplhckblg)** and **[Opera Add-ons](https://addons.opera.com/extensions/details/adhan-focus-muslim-prayer-times-auto-pause/)** · source on [GitHub](https://github.com/bilalahamad0/adhan-ce). It's the browser-side sibling of my Raspberry Pi [Smart-Home IoT Media Caster](https://bilalahamad.com/projects#adhan) and reuses the same [adhan-api](https://github.com/bilalahamad0/adhan-api) schedule source.
...
<video
  src="/images/adhan-ce-demo.mp4"
  poster="/images/adhan-ce-poster.jpg"
  ...
  playsInline
  controls
  aria-label="Adhan Caster — in-page countdown, cross-tab media pause, full-screen prayer-focus, and resume"
/>
