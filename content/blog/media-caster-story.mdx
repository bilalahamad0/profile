...
date: "2025-08-12"
description: "Building a prayer-time IoT orchestration system with Raspberry Pi, ADB, and Sony Android TV — compressed from 3 weeks to 4 days using AI pair programming."
tags: ["IoT", "Raspberry Pi", "ADB", "Node.js", "Android TV"]
category: "Project Story"
featured: false
---

# Smart-Home IoT Media Caster
...
I started working with **Antigravity (Gemini 2.5 Flash/Pro)** as an intelligent pair programmer. The difference was immediate.
