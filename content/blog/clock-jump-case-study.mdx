...
date: "2026-05-12"
description: "How an unexpected network outage and NTP clock jump broke a Node.js IoT scheduler — and how we engineered a resilient, self-healing pipeline."
...
The system's success-rate and low-latency KPIs were destroyed in a matter of seconds. 
