...
export const experienceData = [
  ...
  { role: "Test Lead / Senior Quality Assurance Engineer II", company: "Amazon Lab126", location: "Sunnyvale, CA", duration: "Jun 2018 - Jun 2021", desc: "Alexa IoT testing (Dash, Echo Auto, Echo Buds). Automated VUI tests saving $3M.", file: "/logos/amazon.png", faang: true, invertLogo: false },
  ...
  { role: "Test Engineer", company: "Cisco (via Cognizant)", location: "San Jose, CA", duration: "Sep 2015 - Jan 2016", desc: "Python-based framework for Set-top-Box Video Streaming automation.", file: "/logos/cisco.png", faang: false, invertLogo: false },
  { role: "Radio Validation Engineer", company: "Wistron Mobile", location: "San Jose, CA", duration: "Dec 2014 - Sep 2015", desc: "Pre-certification and Interoperability testing on Android/BlackBerry handsets.", file: "/logos/wistron.png", faang: false, invertLogo: true },
