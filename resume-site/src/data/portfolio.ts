...
export const experienceData = [
  ...
  { role: "Senior SW Engineer in Test", company: "Motorola Mobility (via L&T Infotech)", location: "Sunnyvale, CA", duration: "Oct 2009 - Dec 2014", desc: "Bluetooth automation framework for mobile handsets showcasing $2.1M savings.", file: "/logos/motorola.png", faang: false, invertLogo: false },
