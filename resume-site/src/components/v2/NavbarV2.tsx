  ...
  return (
    ...
    >
      <nav className="glass border border-white/10 bg-black/20 backdrop-blur-md rounded-full px-6 py-3 flex items-center gap-6 pointer-events-auto h-14">
        ...
        <div className="flex items-center gap-5 sm:gap-6 text-sm font-medium text-zinc-300">
          ...
          <Link href="https://github.com/bilalahamad0" target="_blank" className="flex items-center gap-2 hover:text-white transition-colors group">
            <svg className="w-4 h-4 text-zinc-400 group-hover:text-zinc-100 transition-colors" viewBox="0 0 24 24" fill="currentColor">
