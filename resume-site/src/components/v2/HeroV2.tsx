...
function InfographicBackground() {
  return (
    <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none z-0">
      ...
      <svg className="absolute inset-0 w-full h-full opacity-[0.08]" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
      ...
      {/* Floating Animated Technical Icons - Perfectly Balanced */}
